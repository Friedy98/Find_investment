...
class MilestoneEditPage extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<MilestoneEditPage> createState() => _MilestoneEditPageState();
}

class _MilestoneEditPageState extends ConsumerState<MilestoneEditPage> {
  ...
  void initState() {
    ...
    ref
        ...
        .fetchMilestoneById(widget.milestoneId);
  }
  ...
  Widget build(BuildContext context) {
    ...
    final milestone = milestoneState.selectedMilestone;
      ...
      child: ElevatedButton(
        onPressed: () {
          if (_formKey.currentState!.validate() && _dueDate != null) {
            ...
            ref
                .read(projectMilestoneProvider.notifier)
                .updateMilestone(widget.milestoneId, data)
                .then((_) {
              context.pop();
            });
          } else {
